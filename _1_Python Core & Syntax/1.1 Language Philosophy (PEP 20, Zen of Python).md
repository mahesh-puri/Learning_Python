...
# 🐍 Chapter 1.1 – Python Language Philosophy (PEP 20, The Zen of Python)
...
Output:
```
The Zen of Python, by Tim Peters  Beautiful is better than ugly. Explicit is better than implicit. ... Namespaces are one honking great idea -- let's do more of those!
```
...
⚡ Fun fact: In later Python versions, you can also access the **encoded string directly**:

```
import this print(this.s)  # the ROT13 text
```


---
This is encoded with **ROT13** (Caesar cipher with +13 shift).
...
✅ Explicit imports tell the reader exactly what’s used.
...
✅ One-liner `dataclass` is explainable & elegant.
...
- **Readability, Explicitness, Simplicity** → always the guiding light.
